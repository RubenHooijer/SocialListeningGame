	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 tex2DNode109 = tex2D( _TextureSample0, uv_TextureSample0 );
				
				float3 temp_cast_1 = (tex2DNode109.r).xxx;
				float grayscale113 = Luminance(temp_cast_1);
				float lerpResult117 = lerp( 0.0 , _Float1 , ( grayscale113 * 2.0 ));
				float clampResult118 = clamp( lerpResult117 , 0.0 , 1.0 );
				
				float3 Albedo = tex2DNode109.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _spec * clampResult118 );
				float Smoothness = ( _smoothness * clampResult118 );
				float Occlusion = 1;
				float Alpha = clampResult118;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode109 = tex2D( _TextureSample0, uv_TextureSample0 );
				float3 temp_cast_0 = (tex2DNode109.r).xxx;
				float grayscale113 = Luminance(temp_cast_0);
				float lerpResult117 = lerp( 0.0 , _Float1 , ( grayscale113 * 2.0 ));
				float clampResult118 = clamp( lerpResult117 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18000
200;218;1227;631;1014.336;558.5036;1.3;True;False
Node;AmplifyShaderEditor.SamplerNode;109;-646.2759,-484.5152;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;-1;5c55a4422cfc885449a22565268b85a4;5c55a4422cfc885449a22565268b85a4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCGrayscale;113;-716.5295,-251.7427;Inherit;True;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;116;-610.5295,-37.74274;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;False;0;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;119;-431.9868,68.97598;Inherit;False;Property;_Float1;Float 1;3;0;Create;True;0;0;False;0;8;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;115;-409.5295,-150.7427;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;117;-277.9868,21.97598;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;5;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;118;16.01318,116.976;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;120;180.9272,-209.3713;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;112;-153.3763,-99.42902;Inherit;False;Property;_smoothness;smoothness;2;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;125;157.6946,-365.0845;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;23;367.0993,-309.6972;Inherit;False;331;377;c;1;99;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;110;-162.0667,-213.9903;Inherit;False;Property;_spec;spec;1;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;47;-3873.479,-378.17;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;121;170.9272,-119.3713;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;99;417.0993,-259.6972;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;Base Water;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;14;False;False;False;True;2;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;14;Workflow;1;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Cast Shadows;0;Receive Shadows;0;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;False;True;True;True;False;;0
...
WireConnection;99;3;120;0
WireConnection;99;4;121;0
WireConnection;99;6;118;0
ASEEND*/
//CHKSM=00FABBD9B830915B04D6487A024E8A7488360869