...
namespace Oasez.Extensions.Debugging
{

    public static class DebugExtensions
    {
        private const float ARROW_DIST = 0.1f;
        ...
        public static void DrawArrow(Vector3 start, Vector3 dir, Color color, float duration)
        {
            ...
            //4 arrows
            Debug.DrawLine(rayEnd, arrowHeight + Vector3.right * ARROW_DIST, color, duration);
            Debug.DrawLine(rayEnd, arrowHeight + Vector3.left * ARROW_DIST, color, duration);
            Debug.DrawLine(rayEnd, arrowHeight + Vector3.forward * ARROW_DIST, color, duration);
            Debug.DrawLine(rayEnd, arrowHeight + Vector3.back * ARROW_DIST, color, duration);

            //connection between arrows
            Debug.DrawLine(arrowHeight + Vector3.right * ARROW_DIST, arrowHeight + Vector3.left * ARROW_DIST, color, duration);
            Debug.DrawLine(arrowHeight + Vector3.forward * ARROW_DIST, arrowHeight + Vector3.back * ARROW_DIST, color, duration);
        }
